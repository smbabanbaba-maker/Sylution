...
import { C as STATS, c as BRAND_IMAGES, i as Reveal } from "./router-Wf-YWA0T.mjs";
import { n as SectionHeading, t as PageHero } from "./PageHero-BCY8ciXe.mjs";
import { t as CTASection } from "./CTASection-BQDyNKKd.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/about-BJ1lvT2e.js
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Reveal, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionHeading, {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "That result funded the next system, then the next. Today SYLUTION designs its own electronics, writes its own software, flies its own drones, trains thousands of farmers and delivers full projects for banks, governments, NGOs, universities and private estates." }),

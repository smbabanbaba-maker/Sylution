...
import { _ as IOT_APPLICATIONS, c as BRAND_IMAGES, i as Reveal, v as IOT_STACK } from "./router-CcDw5ofK.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/iot-DwVosoRW.js
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						...
						children: "Demonstration data, generated in your browser to illustrate the interface. Production deployments stream from real SYLUTION gateways."
					})
				]
			}) })]
		})
